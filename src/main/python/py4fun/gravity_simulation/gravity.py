...
class GravityField:
    ...
    def __init__(self, integratin_setp=0.1, G=0.1):
        # gravity constant
        self.g = G
    ...
    def __update_anim__(self, i, arg):
        ...
        X, Y, M = self.x_cordinates, self.y_cordinates, self._masses
        ...
        # if self.show_trajectory and m_plot > 100:
        #     plt.plot(X, Y, color='#0f0f0f80', linewidth=linewidth)
        # else:
